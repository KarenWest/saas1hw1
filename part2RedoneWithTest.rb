    ...
    if lenTournament == 2 # start of tournament had 8 players
      ...
      result = rps_game_winner(lastTournamentGame)
        ...
        semiFinals.each do |semifinalGame|
          ...
          finalOf16PlayerGame.concat([result])
        end
        puts "final game 16 player"
        puts finalOf16PlayerGame
        result = rps_game_winner(finalOf16PlayerGame)
    end
  end
  return result
end
...
Failures:
  ...
  1) #rps_tournament_winner should still be able to handle the case where a tournament is just one game [10 points]
     ...
     WrongNumberOfPlayersError:
       WrongNumberOfPlayersError
     # /tmp/rspec20130411-21359-118cp9w.rb:150:in `rps_game_winner'
     # /tmp/rspec20130411-21359-118cp9w.rb:87:in `block (2 levels) in rps_tournament_winner'
     # /tmp/rspec20130411-21359-118cp9w.rb:83:in `each'
     # /tmp/rspec20130411-21359-118cp9w.rb:83:in `block in rps_tournament_winner'
     # /tmp/rspec20130411-21359-118cp9w.rb:76:in `each'
     # /tmp/rspec20130411-21359-118cp9w.rb:76:in `rps_tournament_winner'
     # /tmp/rspec20130411-21359-118cp9w.rb:252:in `block (2 levels) in <top (required)>'
     # /tmp/rspec20130411-21359-118cp9w.rb:212:in `block (3 levels) in <top (required)>'
     # /tmp/rspec20130411-21359-118cp9w.rb:211:in `block (2 levels) in <top (required)>'
  ...
  2) #rps_tournament_winner should return the correct winner in the cases of 16 and 32-man tournaments [40 points]
     ...
     # /tmp/rspec20130411-21359-118cp9w.rb:158:in `block in rps_game_winner'
     # /tmp/rspec20130411-21359-118cp9w.rb:156:in `each'
     # /tmp/rspec20130411-21359-118cp9w.rb:156:in `rps_game_winner'
     # /tmp/rspec20130411-21359-118cp9w.rb:87:in `block (2 levels) in rps_tournament_winner'
     # /tmp/rspec20130411-21359-118cp9w.rb:83:in `each'
     # /tmp/rspec20130411-21359-118cp9w.rb:83:in `block in rps_tournament_winner'
     # /tmp/rspec20130411-21359-118cp9w.rb:76:in `each'
     # /tmp/rspec20130411-21359-118cp9w.rb:76:in `rps_tournament_winner'
     # /tmp/rspec20130411-21359-118cp9w.rb:394:in `block (2 levels) in <top (required)>'
     # /tmp/rspec20130411-21359-118cp9w.rb:212:in `block (3 levels) in <top (required)>'
     # /tmp/rspec20130411-21359-118cp9w.rb:211:in `block (2 levels) in <top (required)>'
     # lib/graders/rspec_grader/rspec_sandbox.rb:9:in `block (3 levels) in <top (required)>'
     # lib/graders/rspec_grader/rspec_sandbox.rb:8:in `block (2 levels) in <top (required)>'
...
Finished in 0.04233 seconds
10 examples, 2 failures

Failed examples:

rspec /tmp/rspec20130411-21359-118cp9w.rb:250 # #rps_tournament_winner should still be able to handle the case where a tournament is just one game [10 points]
rspec /tmp/rspec20130411-21359-118cp9w.rb:291 # #rps_tournament_winner should return the correct winner in the cases of 16 and 32-man tournaments [40 points]
=end
